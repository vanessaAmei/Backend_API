...
class Smsgateway {
    ...
    function __construct() {
        $this->email = null;
        $this->password = null;
        $this->authorization = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJhZG1pbiIsImlhdCI6MTU4ODUwOTM0MywiZXhwIjo0MTAyNDQ0ODAwLCJ1aWQiOjc5OTYwLCJyb2xlcyI6WyJST0xFX1VTRVIiXX0.ydIgG-5mFv6_E_5Eo5wpDqvkbWmYnAACveFNBPtWqV4';
    }
