...
class tp_detail_model extends CI_Model
{
    ...
    public function getAll() {
        ...
        $this->db->select('a.id_detail_tp, c.kode as "kode", a.id_tp, b.harga as "harga", a.id_produk as "id_produk", b.stok as "stok", b.nama as "produk", a.jumlah , a.total');
    ...
    public function destroy($id) { //Fungsi untuk Soft Delete
        ...
        if(empty($this->db->select('*')->where(array('id_detail_tp' => $id))->get($this->table)->row())) 
